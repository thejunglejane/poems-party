...
During this project, I was surprised by how many poems appear on the internet with incomplete or no citation information. I've included a [bibliography](https://github.com/thejunglejane/poems-party/tree/main/data/BIBLIOGRAPHY.md) containing references for publication date information. Rather than provide citation information for each poem, the bibliography cites material that helped answer the question "when was each poem first published?" As a result, it focuses on those poems whose first publication was hard to pin down.
